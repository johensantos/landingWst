...
<header>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-transparent fixed-top animated fadeIn fast" id="barraNavegacion"
        ...
        <div class="container-fluid">
            ...
            <div class="dropdown">
                <a class="btn text-white botonOcultoNavBar dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"  style="border: 1px solid white">
            ...
            <div class="collapse navbar-collapse" id="navbarColor03">
                <ul class="navbar-nav ml-auto itemsMenu ">
                    <li class="nav-item active">
                        <a style="font-size: 1.1em" class="nav-link text-white  active" href="#quienesSomos">Quienes
                            Somos</a>
                    </li>
                    <li class="divider-vertical-second-menu sm"></li>
                    <li class="nav-item">
                        <a style="font-size: 1.1em" class="nav-link text-white" href="#nuestrosCursos">Nuestros Cursos</a>
                    </li>
                    <li class="divider-vertical-second-menu sm"></li>
                    <li class="nav-item">
                        <a style="font-size: 1.1em" class="nav-link text-white" href="#nuestrosClientes">Nuestros Clientes</a>
                    </li>
                    <li class="divider-vertical-second-menu sm"></li>
                    <li class="nav-item">
                        <a style="font-size: 1.1em" class="nav-link text-white" href="#preguntasFrecuentes">Preguntas Frecuentes</a>
                    </li>
                    ...
                    <li class="nav-item">
                        ...
                        <div class="dropdown">
                            <a style="font-size: 1.1em"
                               class=" quitarEnMovil dropdown-toggle btn btn-lg mx-2  btn-warning text-white" data-toggle="dropdown" aria-haspopup="true">
                                <i class="fas fa-globe-americas"></i>
                            </a>
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                <a class="dropdown-item" href="#">Español</a>
...
<div class="container">
    <main id="quienesSomos">
        <div class="row">
            <div class="col">
                <h1 class="animated fadeIn slow">Bienvenidos</h1>
                <hr>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col">
                            <h5 class="text-center">Compañia <i class="fas fa-building"></i></h5>
                        </div>
                    </div>

                    <div class="row mt-3">
                        <div class="col-6 col-md-6 text-center">
                            <a href="https://worksafetytech.com/login.php?ext=x#swipe-1" class="btn btn-primary">Iniciar
                                Sesión</a>
                        </div>
                        <div class="col-6 col-md-6 text-center">
                            <a href="https://worksafetytech.com/registerCompany.php" class="btn btn-outline-primary">Registrarse</a>
                        </div>
                    ...
                    <div class="row">
                        <div class="col">
                            <h5 class="text-center">Trabajador <i class="fas fa-hard-hat"></i></h5>
                        </div>
                    </div>

                    <div class="row mt-3 mb-5">
                        <div class="col-6 col-md-6 text-center">
                            <a href="https://worksafetytech.com/login.php?ext=x#swipe-2" class="btn btn-primary">Iniciar
                                Sesión</a>
                        </div>
                        <div class="col-6 col-md-6 text-center">
                            <a href="https://worksafetytech.com/register.php" class="btn btn-outline-primary">Registrarse</a>
                        </div>
